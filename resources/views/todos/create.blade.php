...
<div class="mx-auto max-w-2xl">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold tracking-tight text-[#0079bf]">Create New Task</h1>
        <p class="mt-2 text-[#5067c5]">Add a new task to your todo list and stay organized</p>
    </div>
